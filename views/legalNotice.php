<main class="container-fluid">
    <div class="row">
        <div class="col">
            <div class="d-flex flex-column mt-5 p-lg-5">
                ...
                <div class="box d-flex flex-column m-lg-5 p-lg-5">
                    <div class="amorce pt-3">
                    ...
                    <div class="pt-lg-5 pt-3">
                        ...
                        <p class="source">*Rédigé sur http://legalplace.fr</p>
                    </div>
