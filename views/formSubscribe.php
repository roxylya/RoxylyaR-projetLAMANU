...
<form method="post" class="connect mt-3 mb-5 medium gold fondamento" enctype="multipart/form-data" novalidate>
    <div class="d-flex flex-column justify-content-around align-items-center pt-3 px-1 px-lg-0">
        ...
        <div class="w-100 checkCgu form-group little py-2 d-flex justify-content-around align-items-center">
            <input type="checkbox" id="cGU" name="cGU">
            <label class="" for="cGU"> J'ai lu et j'accepte les <a href="/conditions-generales-d-utilisation.html"> Conditions Générales d'Utilisation</a>.</label>
        </div>
