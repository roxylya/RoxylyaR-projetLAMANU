    ...
    <div class="row">
        <div class="col">
            <div class="d-flex flex-column justify-content-center align-items-center mt-5">
                ...
                <div class="box d-flex flex-column justify-content-center align-items-center p-md-5 m-3 p-3">
                    ...
                    <form method="post" action="/controllers/dashboard/deleteUserAccountCtrl.php">
                        ...
                        <div class="btnChoice d-flex justify-content-around align-items-center">
                            <a class="text-center" href="/controllers/dashboard/userAccountCtrl.php"> <button type="button" class="btn btnNo text-center" data-bs-dismiss="modal">Non</button></a>
                            <a class="text-center" href="/controllers/dashboard/deleteUserAccountCtrl.php"> <button type="submit" class="btn btnDelete text-center">Oui</button></a>
                        </div>
                    </form>
                </div>
