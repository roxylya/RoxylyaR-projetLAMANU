            ...
            <div class="userConnected d-flex flex-column justify-content-center align-items-center mt-5">
                ...
                <div class="profilUser mt-5 p-3">
                    <div class="actionUser p-5">
                        <a href="/controllers/dashboard/profilAccountCtrl.php">
                        ...
                        <a href="/controllers/dashboard/ordersUserCtrl.php">
                    ...
                    <div class="lookUser p-5">
                        <a href="/controllers/dashboard/dressingUserCtrl.php"><div class="btnUserAccount d-flex justify-content-around align-items-center"><img src="/public/assets/img/armoire.png" alt="">Mon <br> dressing</div></a>
                        <a href="/controllers/dashboard/galleryUserCtrl.php"><div class="btnUserAccount d-flex justify-content-around align-items-center"><img src="/public/assets/img/tableau.png" alt="">Ma <br> galerie</div></a>
                    </div>
                </div>
