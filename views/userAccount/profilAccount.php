...
<p class="py-1 fondamento blue"><?= (isset($_GET["code"]))  ? CODES[$_GET["code"]] : '' ?></p>

    <!-- ouverture formulaire -->
    <form method="post" class="connect mt-3 mb-5 medium gold blackClover d-flex flex-column justify-content-center align-items-center p-3" enctype="multipart/form-data" novalidate>
        <!-- mail -->
        ...
        <div class="w-100 form-group d-flex flex-column justify-content-center align-items-center pb-3">
            <button type="submit" id="submit" class="btn text-center my-2 blackClover">Modifier</button>
        </div>
