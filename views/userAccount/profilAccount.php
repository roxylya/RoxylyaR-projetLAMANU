...
<div class="d-flex flex-column justify-content-around align-items-center mt-3 mb-5">
    <div class="w-100 d-flex flex-lg-row flex-column justify-content-between align-items-center">
        <!-- ouverture formulaire -->
        <form method="post" class="box m-3 medium gold blackClover d-flex flex-column flex-lg-row justify-content-center align-items-center p-3">
            <!-- mail -->
    ...
    <div class="d-flex flex-lg-row flex-column justify-content-between align-items-center">
        ...
        <form method="post" class="box m-3 medium gold blackClover d-flex flex-column flex-lg-row justify-content-center align-items-center p-3">
            <div class="d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control fondamento" id="password" name="password" value="<?= $password ?? '' ?>" pattern="<?= REGEX_PASSWORD ?>" required>
                </div>
                <!-- confirme mot de passe -->
                <div class="form-group pt-2 pt-lg-0">
                    <label for="passwordConfirm">Confirmer :</label>
                    <input type="password" class="form-control fondamento" id="passwordConfirm" name="passwordConfirm" value="<?= $passwordConfirm ?? '' ?>" pattern="<?= REGEX_PASSWORD ?>" required>
                </div>
        ...
        <!-- récupération avatar -->
        <!-- ouverture formulaire -->
        <form method="post" class="box m-3 medium gold blackClover d-flex flex-column flex-lg-row justify-content-center align-items-center p-3" enctype="multipart/form-data">
            <div class="form-group">
    ...
    <!-- fermeture formulaire -->
    <a class="delete align-self-center fondamento mt-3" href="/controllers/userAccount/deleteUserAccountCtrl.php">Supprimer mon compte</a>
</div>