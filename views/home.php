             ...
             <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                 <div class="carousel-inner">
                     <div class="carousel-item active">
                         <img src="/public/assets/img/carouselavatargwizio.png" class="d-block w-100" alt="avatar Gwizio">
                     </div>
                     <div class="carousel-item">
                         <img src="/public/assets/img/carouselban.png" class="d-block w-100" alt="bannière Cassiopée Jangle Nox">
                     </div>
                     <div class="carousel-item">
                         <img src="/public/assets/img/carouselCindy.png" class="d-block w-100" alt="personnage Cindy enceinte robe rouge">
                     </div>
                     <div class="carousel-item">
                         <img src="/public/assets/img/carouselflorantis.png" class="d-block w-100" alt="personnage Florantis capitaine bleu et rouge">
                     </div>
                 </div>
             </div>
             <!-- carousel end -->
         ...
         <div class="col bgAccueilText d-flex flex-row align-items-center justify-content-around py-3">
             ...
             <div id="carouselExampleSlidesOnly" class="carousel slide w-50" data-bs-ride="carousel">
                 <div class="carousel-inner">
                     ...
                     <div class="carousel-item">
                         <img src="/public/assets/img/carouselban.png" class="d-block " alt="bannière Cassiopée Jangle Nox">
                     </div>
                     <div class="carousel-item">
                         <img src="/public/assets/img/carouselCindy.png" class="d-block" alt="personnage Cindy enceinte robe rouge">
                     </div>
                     <div class="carousel-item">
                         <img src="/public/assets/img/carouselflorantis.png" class="d-block" alt="personnage Florantis capitaine bleu et rouge">
                     </div>
                 </div>
             </div>
             <!-- carousel end -->
